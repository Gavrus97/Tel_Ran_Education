...
public class CustomLinkedList<T> implements CustomList<T> {
    ...
    /**
     * The method finds the most left node containing this value
     *
     * @param value that must be found
    ...
    public void insert(int index, T value) {
        ...
        if (index == size) {
            ...
            right = getNodeByIndex(index); //throws exception in index < 0 or index >= size
            left = right.prev;
        }
